...
use solana_program_my_program_client::{accounts::Counter, instructions::CreateBuilder};
...
#[tokio::test]
async fn create() {
    let mut context = ProgramTest::new("solana_program_my_program", solana_program_my_program_client::ID, None)
        .start_with_context()
        .await;
